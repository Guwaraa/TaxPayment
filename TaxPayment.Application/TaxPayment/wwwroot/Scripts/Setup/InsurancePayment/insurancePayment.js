var InsurancePaymentManagement = (function (insurancePaymentManagement, $) {
    "use strict";
    insurancePaymentManagement.insurancePayment = function () {
        var config = {
            base_url: null,
            file_url: "/",
            img_url: "/img/",
        ...
        return ({
            renderIndex: function () {
                $("#insurancePayment").DataTable({
                    "responsive": true,
                    "processing": true,
                    "serverSide": true,
                    "ajax": {
                        "type": 'POST',
                        "url": "/InsurancePayment/GetGridDetails",
                        "data": function (json) {
                            return json;
                        }
                    },
                    ...
                    "columns": [
                        ...
                        { 'data': 'InsuranceRate', "orderable": false },
                    ...
                    "initComplete": function () {
                        $("#insurancePayment").on("click", ".confirmation",
                            function (event) {
...
}(InsurancePaymentManagement || {}, jQuery));